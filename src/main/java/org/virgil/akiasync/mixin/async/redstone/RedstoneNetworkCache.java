...
public class RedstoneNetworkCache {
    ...
    private void cleanupExpiredEntries() {
        ...
        networkCache.entrySet().removeIf(entry -> 
    ...
    public static class CachedNetwork {
        ...
        private static final long EXPIRATION_MS = 30000; // 30 seconds
        ...
        public boolean isExpired(long currentTime) {
            return (currentTime - createTime) > EXPIRATION_MS;
        }
