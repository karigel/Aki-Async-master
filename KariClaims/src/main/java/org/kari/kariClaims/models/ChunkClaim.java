...
public class ChunkClaim {
    ...
    private boolean powerCellHopperInteraction = false; // 能源箱能否和漏斗互动
    ...
    public boolean isPowerCellHopperInteraction() {
        return powerCellHopperInteraction;
    }
    
    public void setPowerCellHopperInteraction(boolean powerCellHopperInteraction) {
        this.powerCellHopperInteraction = powerCellHopperInteraction;
    }
}
