...
public class ChunkClaimListener implements Listener {
    ...
    // 玩家最后所在区块缓存，用于优化移动检查
    private final java.util.Map<java.util.UUID, String> lastChunkMap = new java.util.concurrent.ConcurrentHashMap<>();
    ...
    public void onPlayerMove(PlayerMoveEvent event) {
        ...
        // 使用缓存键检查是否需要查询
        String chunkKey = to.getWorld().getName() + ":" + toChunkX + ":" + toChunkZ;
        String lastChunk = lastChunkMap.put(player.getUniqueId(), chunkKey);
